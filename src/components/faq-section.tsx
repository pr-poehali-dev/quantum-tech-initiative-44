...
export function FAQSection() {
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "Да, именно для этого создан deway API Gateway. Вы получаете управление ключами, rate limiting, квоты и трекинг использования — всё готово для интеграции в ваш сервис.",
    },
    {
